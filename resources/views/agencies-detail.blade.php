                                                        ...
                                                        <ul>
                                                            ...
                                                            <li class="dropdown2 current"><a href="#">Agencies</a>
                                                                <ul>
                                                                    ...
                                                                    <li class="current"><a
                                                                            href="agencies-detail.html">Agencies
                                                                            Detail</a></li>
                            ...
                            <div class="post">
                                ...
                                <div class="box-avatar flex">
                                    <div class="avatar flex-none">
                                        <img class="img-border" src="assets/images/img-box/agencies-detail-avatar.jpg"
                                            alt="images">
                                    </div>
                                    <div class="content ">
                                        <div class="title-avatar fs-30 fw-7 lh-45">Lorem House</div>
                                        <p class="icon-p text-color-4">2118 Thornridge Cir. Syracuse, Connecticut 35624
                                        </p>
                                    </div>
                                </div>
                                <div class="wrap-description">
                                    ...
                                    <ul class="inner flex">
                                        ...
                                        <li class="two"><a
                                                href="mailto:loremhouse@gmail.com">loremhouse@gmail.com</a></li>
                                    </ul>
                                    <div class="box-text">
                                        <h3 class="titles title-2">About Lorem House</h3>
                                        <p class="text-1 text-color-2">Lorem ipsum dolor sit amet, consectetur
                                            adipiscing elit. Aliquam risus leo, blandit vitae diam a, vestibulum viverra
                                            nisi.
                                            Vestibulum ullamcorper velit eget mattis aliquam. Proin dapibus luctus
                                            pulvinar. Integer et libero ut purus bibendum gravida
                                            non ac tellus. Proin sed tellus porttitor, varius mauris vitae, tincidunt
                                            augue. Sed consectetur magna elit, sit amet faucibus
                                            tortor sodales vitae. Maecenas quis arcu est. Nam sit amet neque vestibulum,
                                            fringilla elit sit amet, volutpat nunc.</p>
                                        <p class="text-color-2">Aliquam non lorem consequat, luctus dui et, auctor
                                            nisi. Aenean placerat sapien at augue lacinia, non semper urna tempor.
                                            Mauris sit amet elit orci.</p>
                                    </div>
                                    <div class="box-map">
                                ...
                                <div class="group-button-view ">
                                    <a class="sc-button btn-icon2 btn-1 one btn-svg center"
                                        href="properties-grid.html">
                                        <span>View all my listing</span>
                                        <svg width="18" height="10" viewBox="0 0 14 7" fill="none"
                                            xmlns="http://www.w3.org/2000/svg">
                                            <path d="M10.5 1L13 3.5M13 3.5L10.5 6M13 3.5H1" stroke="#FF9700"
                                                    ...
                                                    <div class="wd-find-select ">
                                                        ...
                                                        <div class="form-group-1 search-form form-style2 relative">
                                                            ...
                                                            <input type="search" class="search-field"
                                                                placeholder="Agent’s name" value=""
                                                            ...
                                                            <div class="group-select">
                                                                <div class="nice-select" tabindex="0"><span
                                                                    ...
                                                                    <ul class="list style">
                                                                        ...
                                                                        <li data-value="smarrt-home" class="option ">
                                                                            Smart home</li>
                                                                    </ul>
                                                                </div>
                                                            </div>
                                                            ...
                                                            <div class="group-select">
                                                                <div class="nice-select" tabindex="0"><span
                                                                    ...
                                                                    <ul class="list">
                                                                        ...
                                                                        <li data-value="Japan" class="option">Japan
                                                                        </li>
