...
<body class="body  ">
    ...
    <div id="wrapper">
        <div id="pagee" class="clearfix">
                                                        ...
                                                        <ul>
                                                            ...
                                                            <li class="dropdown2 current"><a href="#">Property
                                                                ...
                                                                <ul>
                                                                    ...
                                                                    <li class="current"><a
                                                                            href="properties-grid-sidebar-v2.html">Property
            ...
            <!-- title page -->
            <section class="flat-title-page inner style">
                                    ...
                                    <div class="box box-dream hv-one style-dream wg-box">
                                        <div class="image-group relative ">
                                            ...
                                            <div class="swiper-container noo carousel-2 img-style">
                                                ...
                                                <div class="swiper-wrapper ">
                                                    <div class="swiper-slide"><img
                                                            src="assets/images/house/featured-38.jpg" alt="images">
                                                    </div>
                                                    <div class="swiper-slide"><img
                                        ...
                                        <div class="image-group relative ">
                                            ...
                                            <div class="swiper-container noo carousel-2 img-style">
                                                ...
                                                <div class="swiper-wrapper ">
                                                    ...
                                                    <div class="swiper-slide"><img
                                                            src="assets/images/house/featured-40.jpg" alt="images">
                                                    </div>
                                                    <div class="swiper-slide"><img
                                    ...
                                    <div class="box box-dream hv-one style-dream wg-box">
                                        <div class="image-group relative ">
                                            ...
                                            <div class="swiper-container noo carousel-2 img-style">
                                                ...
                                                <div class="swiper-wrapper ">
                                                    <div class="swiper-slide"><img
                                                            src="assets/images/house/featured-21.jpg" alt="images">
                                                    </div>
                                                    <div class="swiper-slide"><img
                                                            src="assets/images/house/featured-2.jpg" alt="images">
                                                    </div>
                                    ...
                                    <div class="box box-dream hv-one style-dream wg-box">
                                        <div class="image-group relative ">
                                            ...
                                            <div class="swiper-container noo carousel-2 img-style">
                                                ...
                                                <div class="swiper-wrapper ">
                                                    <div class="swiper-slide"><img
                                                            src="assets/images/house/featured-39.jpg" alt="images">
                                                    </div>
                                                    <div class="swiper-slide"><img
                                                            src="assets/images/house/featured-20.jpg" alt="images">
                                                    </div>
                                        ...
                                        <div class="content">
                                            ...
                                            <div class="days-box flex justify-space align-center">
                                                <a class="compare flex align-center fw-6" href="#">Compare</a>
                                                <div class="img-author hv-tool" data-tooltip="Kathryn Murphy"><img
                                                        src="assets/images/author/author-21.jpg" alt="images"></div>
                                                <div class="days">3 years ago</div>
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <div class="box box-dream hv-one style-dream wg-box">
                                        <div class="image-group relative ">
                                            ...
                                            <div class="swiper-container noo carousel-2 img-style">
                                                ...
                                                <div class="swiper-wrapper ">
                                                    <div class="swiper-slide"><img
                                                            src="assets/images/house/featured-41.jpg" alt="images">
                                                    </div>
                                                    <div class="swiper-slide"><img
                                                            src="assets/images/house/featured-12.jpg" alt="images">
                                                    </div>
                                    ...
                                    <div class="box box-dream hv-one style-dream wg-box">
                                        <div class="image-group relative ">
                                            ...
                                            <div class="swiper-container noo carousel-2 img-style">
                                                ...
                                                <div class="swiper-wrapper ">
                                                    <div class="swiper-slide"><img
                                                            src="assets/images/house/featured-42.jpg" alt="images">
                                                    </div>
                                                    <div class="swiper-slide"><img
                                                    ...
                                                    <div class="form-s2">
                                                        <form method="post">
                                                            ...
                                                            <div class="wd-find-select ">
                                                                <div
                                                                    class="form-group-1 search-form form-style2 relative">
                                                                        ...
                                                                        <div class="nice-select" tabindex="0"><span
                                                                            ...
                                                                            <ul class="list style">
                                                                                ...
                                                                                <li data-value="house" class="option">
                                                                                    House</li>
                                                                                <li data-value="rent" class="option">
                                                                                    Rent</li>
                                                                            </ul>
                                                                        </div>
                                                                    </div>
                                                                    ...
                                                                    <div class="group-select">
                                                                        <div class="nice-select" tabindex="0"><span
                                                                            ...
                                                                            <ul class="list">
                                                                                <li data-value class="option selected">
                                                                                    Baths</li>
                                                                                <li data-value="floating"
                                                                                    class="option">Floating baths</li>
                                                                                <li data-value="massage"
                                                                                    class="option">Massage baths</li>
                                                                                <li data-value="floor-standing"
                                                                                    class="option">Floor-standing bath
                                                                                </li>
                                                                                <li data-value="built-in"
                                                                                    class="option">Built-in baths</li>
                                                                            </ul>
                                                                        </div>
                                                                    </div>
                                                                </div>
                                                                    ...
                                                                    <div class="group-select">
                                                                        <div class="nice-select" tabindex="0"><span
                                                                            ...
                                                                            <ul class="list">
                                                                                <li data-value class="option selected">
                                                                                    Beds</li>
                                                                                <li data-value="twin" class="option">
                                                                                    Twin beds</li>
                                                                                <li data-value="bunk" class="option">
                                                                                    Bunk beds</li>
                                                                                <li data-value="kids" class="option">
                                                                                    Kids beds</li>
                                                                                <li data-value="single"
                                                                                    class="option">Single bed</li>
                                                                            </ul>
                                                                        </div>
                                                                    </div>
                                                                </div>
                                                                    ...
                                                                    <div class="inner flex flex-wrap">
                                                                        <div class="group-select">
                                                                            <div class="nice-select" tabindex="0">
                                                                                <span class="current">Min</span>
                                                                                <ul class="list">
                                                                                    <li data-value
                                                                                        class="option selected">Min
                                                                                    </li>
                                                                                    ...
                                                                                    <li data-value="700"
                                                                                        class="option">$700</li>
                                                                                    <li data-value="1000"
                                                                                        class="option">$1,000</li>
                                                                                    <li data-value="1300"
                                                                                        class="option">$1,300</li>
                                                                                    <li data-value="1500"
                                                                                        class="option">$1,500</li>
                                                                                    <li data-value="1700"
                                                                                        class="option">$1,700</li>
                                                                                    <li data-value="2000"
                                                                                        class="option">$2,000</li>
                                                                                </ul>
                                                                            </div>
                                                                        </div>
                                                                        <div class="group-select">
                                                                            <div class="nice-select" tabindex="0">
                                                                                ...
                                                                                <ul class="list">
                                                                                    ...
                                                                                    <li data-value="800"
                                                                                        class="option">$800</li>
                                                                                    <li data-value="1100"
                                                                                        class="option">$1,100</li>
                                                                                    <li data-value="1400"
                                                                                        class="option">$1,400</li>
                                                                                    <li data-value="1600"
                                                                                        class="option">$1,600</li>
                                                                                    <li data-value="1800"
                                                                                        class="option">$1,800</li>
                                                                                    <li data-value="2200"
                                                                                        class="option">$2,200</li>
                                                                                </ul>
                                                                            </div>
                                                                        </div>
                                                                    </div>
