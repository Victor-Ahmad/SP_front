                                                        ...
                                                        <ul>
                                                            ...
                                                            <li class="dropdown2 current"><a href="#">Agents</a>
                                                                <ul>
                                                                    ...
                                                                    <li class="current"><a
                                                                            href="agents-detail.html">Agents Details</a>
                                                                    </li>
                            ...
                            <div class="post">
                                <div class="box flex ">
                                    ...
                                    <div class="content ">
                                        ...
                                        <div class="sub-text flex">
                                            <p class="">Company Agent at </p><span
                                                class="fw-7 font-2 text-color-2"> Themesflat</span>
                                        </div>
                                        <div class="icon-group">
                                            <div class="icon-phone link-style-1"><a href="tel:0123456789"
                                                    class=" fw-7 font-2 text-color-3">+7-445-556-8337</a></div>
                                            <div class="icon-email"><a href="mailto:darlenerobertson@gmail.com"
                                                    class="font-2 ">cameronwilliamson@gmail.com</a></div>
                                ...
                                <div class="box-text">
                                    ...
                                    <p class="text-1 text-color-2">Lorem ipsum dolor sit amet, consectetur adipiscing
                                        ...
                                        Integer et libero ut purus bibendum gravida
                                        non ac tellus. Proin sed tellus porttitor, varius mauris vitae, tincidunt augue.
                                        Sed consectetur magna elit, sit amet faucibus
                                        tortor sodales vitae. Maecenas quis arcu est. Nam sit amet neque vestibulum,
                                        fringilla elit sit amet, volutpat nunc.</p>
                                    <p class="text-color-2">Aliquam non lorem consequat, luctus dui et, auctor nisi.
                                        Aenean placerat sapien at augue lacinia, non semper urna tempor. Mauris sit amet
                                        elit orci.</p>
                                </div>
                                                                ...
                                                                <div class="nice-select" tabindex="0"><span
                                                                    ...
                                                                    <ul class="list">
                                                                        ...
                                                                        <li data-value="Single family home"
                                                                            class="option selected">Single family home
                                                                        </li>
                                                                        <li data-value="Multi family home"
                                                                            class="option">Multi family home</li>
                                                                    </ul>
                                                                </div>
                                                            </div>
                                                        </div>
                                                            ...
                                                            <div class="group-select">
                                                                <div class="nice-select" tabindex="0"><span
                                                                    ...
                                                                    <ul class="list">
                                                                        ...
                                                                        <li data-value="America" class="option">
                                                                            America</li>
                                                                        <li data-value="England"
                                                                            class="option selected">England</li>
