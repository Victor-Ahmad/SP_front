                            ...
                            <div class="col-lg-12">
                                <div class="tf-uploads bg-white">
                                    ...
                                    <div class="wrap-upload ">
                                        <div class="box-upload flex">
                                            ...
                                            <div class="content">
                                                <div class="subtitle">Upload a new avatar”</div>
                                                <div class="button-box relative flex align-center"
                                                    id="upload-profile">
                                                    <a href="#" class="btn-upload sc-button">
                                                        <span class="fw-14 fw-6">Choose file</span> </a>
                                                    <input id="tf-upload-img" type="file" name="profile"
                                                        required="">
                                                    <div class="">No files selected</div>
                                                </div>
                                ...
                                <div class="tf-infomation bg-white">
                                    ...
                                    <div class="info-box info-wg">
                                        <div class="inner-1">
                                            <fieldset>
                                                <label class="title-user fw-6">Full name</label>
                                                <input type="text" placeholder="Ralph Edwards" class="input-form"
                                                    required>
                                            </fieldset>
                                        </div>
                                        <div class="inner-2">
                                            <fieldset class="message-wrap">
                                                ...
                                                <textarea id="comment-message" name="message" rows="4" tabindex="4" aria-required="true"></textarea>
                                            </fieldset>
                                        </div>
                                        <div class="inner-3 inner form-wg flex ">
                                            <div class="wg-box3 select-group">
                                                <fieldset>
                                                    <label class="title-user fw-6">Your company</label>
                                            ...
                                            <div class="wg-box3 select-group">
                                                <fieldset>
                                                    <label class="title-user fw-6">Job</label>
                                            ...
                                            <div class="wg-box3 select-group">
                                                <fieldset>
                                                    <label class="title-user fw-6">Email address</label>
                                                    <input type="email" placeholder="Choose" class="input-form"
                                                        required>
                                                </fieldset>
                                            </div>
                                            <div class="wg-box3 select-group">
                                                <fieldset>
                                                    <label class="title-user fw-6">Your phone</label>
                                                    <input type="tel" placeholder="Choose" class="input-form"
                                                        required>
                                                </fieldset>
                                            </div>
                                        </div>
                                        <div class="inner-4 inner">
                                            <fieldset>
                                                <label class="title-user fw-6">Location</label>
                                                <input type="text" placeholder="Ralph Edwards" class="input-form"
                                                    required>
                                            </fieldset>
                                        </div>
                                        ...
                                        <div class="inner-6 inner">
                                            <fieldset>
                                                <label class="title-user fw-6">Socials</label>
                                                <input type="url" placeholder="url" class="input-form" required>
                                            </fieldset>
                                        </div>
                                ...
                                <div class="tf-bottom">
                                    <div class="title-bottom center text-color-4"> Copyright © 2023 <a
                                            ...
                                            class="text-color-4 fw-6">Themesflat.</a> </div>
                                </div>
                            </div>
                        </div>
                    </div>
