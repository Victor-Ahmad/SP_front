                                                ...
                                                <ul class="navigation clearfix">
                                                    ...
                                                    <li class="dropdown2 current"><a href="#">Blog</a>
                                                        <ul>
                                                            ...
                                                            <li class="current"><a href="blog-detail.html">Blog
                                                                    Detail</a></li>
                                                        </ul>
                                                    </li>
                        ...
                        <div class="col-lg-8">
                            <div class="post">
                                ...
                                <p class="texts-2 fs-16 font-2 lh-29 text-color-2">The average contract interest rate
                                    ...
                                    origination fee) for loans with a 20% down payment. It had been over 7% just a month
                                    ago.</p>
                                <p class="texts-2 fs-16 font-2 lh-29 text-color-2">Mortgage applications to purchase a
                                    ...
                                    than the same week one year ago.</p>
                                <div class="text-box">
                                    <p class="texts fs-16 font-2 lh-29 text-color-2">“Spring has arrived, but the
                                        ...
                                        application activity, volume declined a bit this week even with another small
                                        drop in mortgage rates,” said Mike Fratantoni, MBA’s chief economist.</p>
                                </div>
                                ...
                                <div class="text-box">
                                    <p class="texts fs-16 font-2 lh-29 text-color-2 fw-6">“Although the mortgage rate
                                        ...
                                        6.36%,” added Fratantoni. “While we have seen relative weakness at the high end
                                        of the housing market in recent months, the divergence in rates suggests that
                                        banks may be tightening credit in response to recent challenges, preserving
                                        balance sheet capacity as deposit balances have declined.”</p>
                                </div>
                                ...
                                <p class="texts-2 fs-16 font-2 lh-29 text-color-2">Demand for Federal Housing
                                    ...
                                    those for conventional loans. While there is strong demand from first-time
                                    homebuyers, with millennials hitting their peak buying age, affordability is still a
                                ...
                                <p class="texts-3 fs-16 font-2 lh-29 text-color-2">Applications to refinance a home
                                    ...
                                    from 29.1% the previous week. Rates are 150 basis points higher than they were at
                                    the same time last year, so there are precious few borrowers who can now benefit
                                    from a refinance.</p>
