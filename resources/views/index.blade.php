                            ...
                            <div class="col-lg-12">
                                <div class="inner-container flex justify-space align-center">
                                    ...
                                    <div class="logo-box flex">
                                        <div class="logo"><a href="{{ route('index.view') }}"><img
                                                ...
                                                <ul class="navigation clearfix">
                                                    <li class="dropdown2 current"><a
                                                        ...
                                                        <ul>
                                                            ...
                                                            <li><a href="{{ route('home02.view') }}">Home Page 02</a>
                                                            </li>
                                                            <li><a href="{{ route('home03.view') }}">Home Page 03</a>
                                                            </li>
                                                            <li><a href="{{ route('home04.view') }}">Home Page 04</a>
                                                            </li>
                                                            <li><a href="{{ route('home05.view') }}">Home Page 05</a>
                                                            </li>
                                                        </ul>
                                                    </li>
                                                    <li class="dropdown2"><a href="#">Property</a>
                                                        <ul>
                                                            <li class="dropdown2"><a href="#">Property List</a>
                                                                <ul>
                                                                    <li><a href="{{ route('properties-list.view') }}">Property
                                                                            List</a></li>
                                                                    <li><a
                                                                            href="{{ route('properties-list-sidebar-v1.view') }}">Property
                                                                            List Sidebar V1</a></li>
                                                                    <li><a
                                                                            href="{{ route('properties-list-sidebar-v2.view') }}">Property
