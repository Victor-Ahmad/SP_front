                ...
                <div class="col-lg-12">
                    <div class="tf-upload">
                        ...
                        <div class="wrap-upload center">
                            ...
                            <div class="box-photo">
                                <ul class="flex">
                                    <li class="file-delete"><img src="assets/images/img-box/dashboard-upload-1.jpg" alt="">
                                        <a class="icon-clear remove-file"><i class="far fa-trash-alt"></i></a> </li>
                                    <li class="file-delete"><img src="assets/images/img-box/dashboard-upload-2.jpg" alt="">
                                        <a class="icon-clear remove-file"><i class="far fa-trash-alt"></i></a> </li>
                                    <li class="file-delete"><img src="assets/images/img-box/dashboard-upload-3.jpg" alt="">
                                        <a class="icon-clear remove-file"><i class="far fa-trash-alt"></i></a> </li>
                                    <li class="file-delete"><img src="assets/images/img-box/dashboard-upload-4.jpg" alt="">
                                        <a class="icon-clear remove-file"><i class="far fa-trash-alt"></i></a> </li>
                                    <li class="file-delete"><img src="assets/images/img-box/dashboard-upload-5.jpg" alt="">
                                        <a class="icon-clear remove-file"><i class="far fa-trash-alt"></i></a> </li>
                                </ul>
                            </div>               
                        </div> 
                            ...
                            <div class="inner-2 form-wg flex ">
                                <div class="wg-box2 select-group">
                                    <fieldset>
                                        ...
                                        <input type="tel" placeholder="Choose" class="input-form" required>
                                    </fieldset>
                                </div> 
                                <div class="wg-box2 select-group">
                                    <fieldset>
                                        <label class="title-user fw-6">Zip code *</label>
                                        <input type="text" placeholder="Choose" class="input-form" required>
                                    </fieldset>
                                </div> 
                                <div class="wg-box2 select-group">
                        ...
                        <div class="info-box info-wg">
                            <div class="inner-1 form-wg flex">
                                <div class="wg-box">
                                    ...
                                    <div class="nice-select" tabindex="0"><span class="current font-2 fw-7">$ 750.00</span><span class="month">Per-Month</span>
                                        <ul class="list style">                                                          
                                ...
                                <div class="wg-box">
                                    ...
                                    <div class="nice-select " tabindex="0"><span class="current font-2 fw-7">$ 56.00</span><span class="month">Per-3Month</span>
                                        <ul class="list style">                                                          
                            ...
                            <div class="inner-2 form-wg flex">
                                ...
                                <div class="wg-box">
                                    ...
                                    <div class="box-quantity flex align-center">
                                        <div class="title-sub fs-13"><span class="fw-7">Minimum duration</span><span> (in months)</span></div>
                            ...
                            <div class="inner-4 form-wg flex ">
                                ...
                                <div class="wg-box2 select-group">
                                    <fieldset>
                                        ...
                                        <input type="text" placeholder="eg: 20x20, 20x20x20" class="input-form" required>
                                    </fieldset>
                                </div> 
                            </div> 
                        </div>
                        ...
                        <div class="wrap-amenities flex">
                            <div class="box box-1 flex">
                                <div class="inner-1">
                                    ...
                                    <label class="flex"><input name="newsletter" type="checkbox"  /> 
                                        <span class="btn-checkbox"></span><span class="fs-13">Fully fenced</span> 
                                    </label>
                                    <label class="flex"><input name="newsletter" type="checkbox" /> 
                            ...
                            <div class="box box-2 flex">
                                <div class="inner-1">
                                    ...
                                    <label class="flex"><input name="newsletter" type="checkbox"  /> 
                                        <span class="btn-checkbox"></span><span class="fs-13">Floorboards</span> 
                                    </label>
                                    <label class="flex"><input name="newsletter" type="checkbox" checked /> 
                                        <span class="btn-checkbox"></span><span class="fs-13">Rumpus room</span> 
                                    </label>
                                </div>
                                <div class="inner-2">
                                    <label class="flex"><input name="newsletter" type="checkbox" /> 
                                    ...
                                    <label class="flex"><input name="newsletter" type="checkbox" /> 
                                        <span class="btn-checkbox"></span><span class="fs-13">Workshop</span> 
                                    </label>
                                </div>
                            </div>
                            <div class="box box-3 flex">
                                <div class="inner-1">
                                    ...
                                    <label class="flex"><input name="newsletter" type="checkbox" /> 
                                        <span class="btn-checkbox"></span><span class="fs-13">Air conditioning</span> 
                                    </label>
                                    <label class="flex"><input name="newsletter" type="checkbox"  /> 
                                        <span class="btn-checkbox"></span><span class="fs-13">Heating</span> 
                                    </label>
                                    <label class="flex"><input name="newsletter" type="checkbox" checked  /> 
                                        <span class="btn-checkbox"></span><span class="fs-13">Water tank</span> 
                                    </label>
                                    <label class="flex"><input name="newsletter" type="checkbox"  /> 
                                        <span class="btn-checkbox"></span><span class="fs-13">Solar panels</span> 
                                    </label>
                                    <label class="flex"><input name="newsletter" type="checkbox" /> 
                                        <span class="btn-checkbox"></span><span class="fs-13">Solar hot water</span> 
                                    </label>
                                </div>
                                <div class="inner-2">
                                    <label class="flex"><input name="newsletter" type="checkbox"  /> 
                                        <span class="btn-checkbox"></span><span class="fs-13">Electric stove system</span> 
                                    </label>
                                    <label class="flex"><input name="newsletter" type="checkbox"  /> 
                                        <span class="btn-checkbox"></span><span class="fs-13">Heating system</span> 
                                    </label>
                                    <label class="flex"><input name="newsletter" type="checkbox"  /> 
                                        <span class="btn-checkbox"></span><span class="fs-13">Dust filter</span> 
                                    </label>
                                </div>
                            </div>
                    ...
                    <div class="tf-bottom">
                        <div class="title-bottom center text-color-4"> Copyright © 2023 <a href="https://themeforest.net/user/themesflat/portfolio" class="text-color-2 fw-6">Themesflat.</a> </div>
                    </div>
                </div> 
            </div>
        </div>
