                                ...
                                <div class="inner-container flex justify-space align-center">
                                    ...
                                    <div class="logo-box flex">
                                        <div class="logo"><a href="index.html"><img
                                                    src="assets/images/logo/logo@2x.png" alt="" width="197"
                                                    height="48"></a></div>
                                    </div>
                                                ...
                                                <ul class="navigation clearfix">
                                                    ...
                                                    <li class="dropdown2 current"><a href="#">Property</a>
                                                        <ul>
                                                            ...
                                                            <li class="dropdown2 current"><a href="#">Property
                                                                    Detail</a>
                                                                <ul>
                                                                    <li class="current"><a
                                                                            href="property-detail-v1.html">Property
                                                                            Detail V1</a></li>
                        ...
                        <div class="col-lg-12">
                            <div class="title-inner">
                                <div class="title-group fs-12"><a class="home fw-6 text-color-3"
                                        href="index.html">Home</a><span>Property Listing</span></div>
                            </div>
                        </div>
                    </div>
                </div>
                    ...
                    <div class="row">
                        <div class="col-lg-12">
                            <div class="wrap-house wg-dream flex">
                                <div class="box-1">
                                    <div class="title-heading fs-30 fw-7 lh-45">Villa Belo a large superior luxury
                                        villa</div>
                            ...
                            <div class="wrap-img flex">
                                ...
                                <div class="box-img box-2">
                                    ...
                                    <div class="img-box flex">
                                        <img class="img-3" src="assets/images/img-box/property-3.jpg"
                                            alt="images">
                                        <div class="image">
                                            <img class="img-4" src="assets/images/img-box/property-4.jpg"
                                                alt="images">
                        ...
                        <div class="col-lg-8">
                            <div class="post">
                                                ...
                                                <div class="icon">
                                                    <svg width="18" height="16" viewBox="0 0 18 16"
                                                        ...
                                                        <path
                                                            ...
                                                            stroke="#8E8E93" stroke-miterlimit="10"
                                ...
                                <div class="wrap-text wrap-style">
                                    ...
                                    <p class="text-1 text-color-2">Lorem ipsum dolor sit amet, consectetur adipiscing
                                        elit. Aliquam risus leo, blandit vitae diam a, vestibulum viverra nisi.
                                        Vestibulum ullamcorper velit eget mattis aliquam. Proin dapibus luctus pulvinar.
                                        Integer et libero ut purus bibendum gravida non ac tellus. Proin sed tellus
                                        porttitor, varius mauris vitae, tincidunt augue. Sed consectetur magna elit, sit
                                        amet faucibus tortor sodales vitae. Maecenas quis arcu est. Nam sit amet neque
                                        vestibulum, fringilla elit sit amet, volutpat nunc.</p>
                                    <p class="text-2 text-color-2">Aliquam non lorem consequat, luctus dui et, auctor
                                        nisi. Aenean placerat sapien at augue lacinia, non semper urna tempor. Mauris
                                        sit amet elit orci.</p>
                                ...
                                <div class="wrap-property wrap-style">
                                    ...
                                    <div class="box flex">
                                        <ul>
                                            <li class="flex"><span class="one fw-6">ID</span><span
                                                    class="two">#1234</span></li>
                                            <li class="flex"><span class="one fw-6">Price</span><span
                                                    class="two">$7,500</span></li>
                                            <li class="flex"><span class="one fw-6">Size</span><span
                                                    class="two">150 sqft</span></li>
                                            <li class="flex"><span class="one fw-6">Rooms</span><span
                                                    class="two">9</span></li>
                                            <li class="flex"><span class="one fw-6">Baths</span><span
                                                    class="two">3</span></li>
                                        </ul>
                                        <ul>
                                            ...
                                            <li class="flex"><span class="one fw-6">Status</span><span
                                                    class="two">For sale</span></li>
                                            <li class="flex"><span class="one fw-6">Garage</span><span
                                                    class="two">1</span></li>
                                        </ul>
                                    </div>
                                </div>
                                ...
                                <div class="wrap-map wrap-property wrap-style">
                                    ...
                                    <div class="box flex">
                                        <ul>
                                            <li class="flex"><span class="one fw-6">Address</span><span
                                                    class="two">150 sqft</span></li>
                                            <li class="flex"><span class="one fw-6">City</span><span
                                                    class="two">#1234</span></li>
                                            <li class="flex"><span class="one fw-6">State/county</span><span
                                                    class="two">$7,500</span></li>
                                        </ul>
                                        <ul>
                                            <li class="flex"><span class="one fw-6">Postal code</span><span
                                                    class="two">7.328</span></li>
                                            <li class="flex"><span class="one fw-6">Area</span><span
                                                    class="two">7.328</span></li>
                                            <li class="flex"><span class="one fw-6">Country</span><span
                                                    class="two">2022</span></li>
                                        </ul>
                                    </div>
                                    ...
                                    <div class="flat-accordion fl-faq-content">
                                        <div class="flat-toggle ">
                                            <div class="toggle-title active flex justify-space">
                                                ...
                                                <div class="icon-box flex wg-dream">
                                                    <div class="icons icon-money flex">
                                                        <span><svg width="16" height="17" viewBox="0 0 16 17"
                                                                fill="none" xmlns="http://www.w3.org/2000/svg">
                                                                <path
                                                                ...
                                                                <path
                                                                    ...
                                                                    fill="#8E8E93" />
                                                            </svg></span> <span class="fw-6">Price:
                                                        </span><span>$7,500</span>
                                                    </div>
                                                    <div class="icons icon-3 flex"><span class="fw-6">Size:
                                                        </span><span>4</span></div>
                                                    <div class="icons icon-1 flex"><span class="fw-6">Beds:
                                                        </span><span>150 sqft</span></div>
                                                    <div class="icons icon-2 flex"><span class="fw-6">Baths:
                                            ...
                                            <div class="toggle-content section-desc">
                                                ...
                                                <p class="texts text-color-2">Proin sed tellus porttitor, varius mauris
                                                    vitae, tincidunt augue. Sed consectetur magna elit, sit amet
                                                    faucibus tortor sodales vitae. Maecenas quis arcu est. Nam sit amet
                                                    neque vestibulum, fringilla elit sit amet, volutpat nunc.</p>
                                                <p class="text-color-2">Aliquam non lorem consequat, luctus dui et,
                                                    auctor nisi. Aenean placerat sapien at augue lacinia, non semper
                                                    urna tempor. Mauris sit amet elit orci.</p>
                                            </div>
                                        </div>
                                        <div class="flat-toggle ">
                                ...
                                <div class="wrap-video wrap-style">
                                    ...
                                    <div class="video-box center ">
                                        <div class="post-video flex align-center justify-center  relative">
                                            <img class="img-2" src="assets/images/img-box/property-video.jpg"
                                                alt="images">
                                ...
                                <div class="wrap-virtual wrap-style">
                                    ...
                                    <div class="virtual-box relative flex align-center justify-center">
                                        <div class="images">
                                            <img class="img-2" src="assets/images/img-box/property-6.jpg"
                                                alt="images">
                                        </div>
                                    ...
                                    <div class="box-nearby box-1 flex">
                                        ...
                                        <div class="content">
                                            ...
                                            <div class="title-box flex align-center justify-space">
                                                <div class="title-item"><span class="fw-7 font-2">8/10
                                                    </span><span>Massachusetts Institute of Technology (MIT)</span><span
                                                        class="fw-7 font-2"> 1.5 miles</span></div>
                                            ...
                                            <div class="title-box flex align-center justify-space">
                                                <div class="title-item"><span class="fw-7 font-2">6/10
                                                    </span><span>Stanford University</span><span class="fw-7 font-2"> 2
                                                        miles</span></div>
                                                <div class="start-item flex align-center">
                                                    <div class="star flex">
                                                        <svg version="1.1" xmlns="http://www.w3.org/2000/svg"
                                            ...
                                            <div class="title-box flex align-center justify-space">
                                                <div class="title-item"><span class="fw-7 font-2">5/10
                                                    </span><span>University of Michigan-Ann Arbor</span><span
                                                        class="fw-7 font-2"> 3.5 miles</span></div>
                                                <div class="start-item flex align-center">
                                                    <div class="star flex">
                                                        <svg version="1.1" xmlns="http://www.w3.org/2000/svg"
                                                            xmlns:xlink="http://www.w3.org/1999/xlink" x="0px" y="0px"
                                    ...
                                    <div class="box-nearby box-2 flex">
                                        <div class="icon flex-none">
                                            <svg width="30" height="30" viewBox="0 0 30 30" fill="none"
                                                xmlns="http://www.w3.org/2000/svg">
                                                <mask id="mask0_1532_28657" style="mask-type:luminance"
                                        ...
                                        <div class="content">
                                            <h4>Park</h4>
                                            <div class="title-box flex align-center justify-space">
                                                <div class="title-item"><span class="fw-7 font-2">8/10 </span><span>
                                                        The Wizarding World of Harry Potter </span><span
                                                        class="fw-7 font-2"> 4.5 miles</span></div>
                                                <div class="start-item flex align-center">
                                                    <div class="star flex">
                                                        <svg version="1.1" xmlns="http://www.w3.org/2000/svg"
                                                            xmlns:xlink="http://www.w3.org/1999/xlink" x="0px" y="0px"
                                            ...
                                            <div class="title-box flex align-center justify-space">
                                                <div class="title-item"><span class="fw-7 font-2">7.5/10 </span><span>
                                                        Universal's Islands of Adventure </span><span
                                                        class="fw-7 font-2"> 6 miles</span></div>
                                                <div class="start-item flex align-center">
                                                    <div class="star flex">
                                                        <svg version="1.1" xmlns="http://www.w3.org/2000/svg"
                                                            xmlns:xlink="http://www.w3.org/1999/xlink" x="0px" y="0px"
                                        ...
                                        <div class="respond-comment">
                                            <form method="post" class="comment-form form-submit"
                                                ...
                                                <div class="wg-box">
                                                    ...
                                                    <div class="nice-select" tabindex="0"><span class="current">36
                                                            months</span>
                                                        <ul class="list style">
                                                    ...
                                                    <div class="wg-box">
                                                        ...
                                                        <div class="nice-select " tabindex="0"><span
                                                            ...
                                                            <ul class="list">
                                                                ...
                                                                <li data-value="monthly" class="option selected">
                                                                    Monthly</li>
                                        ...
                                        <ol class="">
                                            <li class="flex">
                                                ...
                                                <div class="content">
                                                    ...
                                                    <div class="img-box">
                                                        <img src="assets/images/img-box/review-1.jpg"
                                                            alt="images">
                                                        <img src="assets/images/img-box/review-2.jpg"
                                                            alt="images">
                                                        <img src="assets/images/img-box/review-3.jpg"
                                                            alt="images">
                                                    </div>
                                                    <div class="icon-box flex">
                                            ...
                                            <li class="flex">
                                                ...
                                                <div class="content">
                                                    ...
                                                    <p class="texts text-color-2">Proin sed tellus porttitor, varius
                                                        ...
                                                        sit amet neque vestibulum, fringilla elit sit amet, volutpat
                                                        nunc.</p>
                                                    <div class="icon-box flex">
                                                        <a class="icon flex align-center">
                                                            <svg width="16" height="15" viewBox="0 0 16 15"
                                        ...
                                        <div class="respond-comment">
                                            ...
                                            <form method="post" id="contactform" class="comment-form form-submit"
                                                ...
                                                <div class="inner-2 align-center flex">
                                                    ...
                                                    <div class="star flex">
                                                        <a class="star flex">
                                                            <svg height="20pt" viewBox="0 -10 511.98685 511"
                                                                width="20pt" xmlns="http://www.w3.org/2000/svg">
                                                                <path
                                                                ...
                                                                <div class="wd-find-select ">
                                                                    <div class="group-select">
                                                                        <div class="nice-select" tabindex="0">
                                                                            ...
                                                                            <ul class="list">
                                                                                <li data-value
                                                                                    class="option selected">Choose
                                                                                    time</li>
                                                                                <li data-value="6" class="option">6h
                                                                                </li>
                                                                                <li data-value="8" class="option">8h
                                                                                </li>
                                                                    ...
                                                                    <div class="widget-form flex">
                                                                        <label class="widget-form ">
                                                                            <input type="checkbox">
                                                                            <span
                                                                                class="btn-checkbox flex-two"></span>
                                                                        </label>
                                                                        <div class="flex fs-13 lh-18">
                                                                            <span class="sub-title">I agree to
                                                                                the</span>
                                                                            <a href="#"
                                                                    ...
                                                                    <div class="button-box center">
                                                                        <button
                                                                            ...
                                                                            <span class="">Submit a Tour
                                                                                Request</span>
                                                                            <svg width="18" height="10"
                                                                                viewBox="0 0 14 7" fill="none"
                                                                                xmlns="http://www.w3.org/2000/svg">
                                                                                <path
                                    ...
                                    <div class="widget-rent style">
                                        ...
                                        <div class="author-box flex align-center">
                                            ...
                                            <div class="content">
                                                ...
                                                <h5 class="link-style-1"><a href="tel:0123456789">(405)
                                                        555-000-999</a></h5>
                                                <a class="fs-12 lh-18"
                                    ...
                                    <div class="widget widget-listings style">
                                        ...
                                        <div class="box-listings flex hover-img3">
                                            ...
                                            <div class="content link-style-1">
                                                <a class="fs-16 lh-24" href="property-detail-v1.html">Gorgeous
                                    ...
                                    <div class="widget widget-estate">
                                        ...
                                        <ul class="group-estate flex">
                                            <li class="box-estate hover-img2">
                                                ...
                                                <div class="content">
                                                    <div class="title link-style-3 fw-6 lh-18"><a
                                                            href="properties-map-v1.html">Moncton</a> </div>
                                            ...
                                            <li class="box-estate hover-img2">
                                                ...
                                                <div class="content">
                                                    <div class="title link-style-3 fw-6 lh-18"><a
                                                            href="properties-map-v1.html">Mississauga</a> </div>
                                                    <p class="fs-12 lh-16 text-color-1">1570 listing</p>
                                                </div>
                                            </li>
                                            <li class="box-estate hover-img2">
                                                ...
                                                <div class="content">
                                                    <div class="title link-style-3 fw-6 lh-18"><a
                                                            href="properties-map-v1.html">Halifax</a> </div>
                                                    <p class="fs-12 lh-16 text-color-1">1570 listing</p>
                                                </div>
                                            </li>
                                            <li class="box-estate hover-img2">
                                                ...
                                                <div class="content">
                                                    <div class="title link-style-3 fw-6 lh-18"><a
                                                            href="properties-map-v1.html">Ottawa</a> </div>
                                                    <p class="fs-12 lh-16 text-color-1">1570 listing</p>
                                                </div>
                                            </li>
                                            <li class="box-estate hover-img2">
                                                ...
                                                <div class="content">
                                                    <div class="title link-style-3 fw-6 lh-18"><a
                                                            href="properties-map-v1.html">Iqaluit</a> </div>
                                                    <p class="fs-12 lh-16 text-color-1">1570 listing</p>
                                                </div>
                                            </li>
                                            <li class="box-estate hover-img2">
                                                ...
                                                <div class="content">
                                                    <div class="title link-style-3 fw-6 lh-18"><a
                                                            href="properties-map-v1.html">Toronto</a> </div>
                                                    <p class="fs-12 lh-16 text-color-1">1570 listing</p>
                                                </div>
                                            </li>
                                        </ul>
                                    ...
                                    <div class="widget widget-ads">
                                        <div class="box-ads">
                                            <div class="content relative z-2">
                                                <h3 class="link-style-3"><a href="property-detail-v1.html">Gorgeous
                                        ...
                                        <div class="box box-dream hv-one">
                                            <div class="image-group relative ">
                                                ...
                                                <div class="swiper-container noo carousel-2 img-style">
                                                    <a href="property-detail-v2.html" class="icon-plus"><img
                                            ...
                                            <div class="content">
                                                <h3 class="link-style-1"><a href="property-detail-v2.html">Gorgeous
                                                        Apartment Building</a> </h3>
                                                <div class="text-address">
                                                    <p class="p-12">58 Hullbrook Road, Billesley, B13 0LA</p>
                                                </div>
                                                <div class="money fs-18 fw-6 text-color-3"><a
                                                        href="property-detail-v2.html">$7,500</a></div>
                                                <div class="icon-box flex">
                    ...
                    <div class="row">
                        <div class="col-lg-12">
                            <div class="heading-section">
                                ...
                                <p class="text-color-2 font-2">Lorem ipsum dolor sit amet, consectetur adipiscing
                        ...
                        <div class="col-lg-12">
                            <div class="wrap-logo flex align-center justify-space">
                                <div class="logo-footer style box-1" id="logo-footer">
                                    <a href="index.html">
                                        <img src="assets/images/logo/logo-footer@2x.png" alt="img"
                                            width="197" height="48">
                                    </a>
                                </div>
                    ...
                    <div class="row">
                        <div class="col-lg-12">
                            <div class="title-bottom center"> Copyright © 2023. Designed & Developed by <a
                                    ...
                                    class="text-color-1">Themesflat.</a> </div>
                        </div>
                    </div>
                </div>
            </div>
