                                                        ...
                                                        <ul>
                                                            ...
                                                            <li class="dropdown2 current"><a href="#">Property
                                                                ...
                                                                <ul>
                                                                    ...
                                                                    <li class="current"><a
                                                                            href="properties-grid-sidebar-v1.html">Property
                                                            ...
                                                            <div class="nice-select" tabindex="0"><span
                                                                ...
                                                                <ul class="list">
                                                                    <li data-value class="option selected">Property
                                                                        type</li>
                                                                    <li data-value="bungalow" class="option">Bungalow
                                                                    </li>
                                                        ...
                                                        <div class="group-select">
                                                            <div class="nice-select" tabindex="0"><span
                                                                ...
                                                                <ul class="list">
                                                                    ...
                                                                    <li data-value="America" class="option d">America
                                                                    </li>
                                                        ...
                                                        <div class="group-select">
                                                            <div class="nice-select" tabindex="0"><span
                                                                ...
                                                                <ul class="list">
                                                                    ...
                                                                    <li data-value="floating" class="option">Floating
                                                                        baths</li>
                                                                    <li data-value="massage" class="option">Massage
                                                                        baths</li>
                                                                    <li data-value="floor-standing" class="option">
                                                                        Floor-standing bath</li>
                                                                    <li data-value="built-in" class="option">Built-in
                                                                        baths</li>
                                                                </ul>
                                                            </div>
                                                        </div>
                                                        ...
                                                        <div class="group-select">
                                                            <div class="nice-select" tabindex="0"><span
                                                                ...
                                                                <ul class="list">
                                                                    ...
                                                                    <li data-value="twin" class="option">Twin beds
                                                                    </li>
                                                                    <li data-value="bunk" class="option">Bunk beds
                                                                    </li>
                                                                    <li data-value="kids" class="option">Kids beds
                                                                    </li>
                                                                    <li data-value="single" class="option">Single bed
                                                                    </li>
                                                                </ul>
                                                            </div>
                                                        </div>
                        ...
                        <div class="post">
                            ...
                            <div class="wrap-item flex ">
                                ...
                                <div class="box box-dream hv-one style-dream">
                                    <div class="image-group relative ">
                                        ...
                                        <div class="swiper-container noo carousel-2 img-style">
                                            ...
                                            <div class="swiper-wrapper ">
                                                ...
                                                <div class="swiper-slide"><img
                                                        src="assets/images/house/featured-23.jpg" alt="images">
                                                </div>
                                                <div class="swiper-slide"><img
                                                        src="assets/images/house/featured-24.jpg" alt="images">
                                                </div>
                                                <div class="swiper-slide"><img
                                    ...
                                    <div class="content">
                                        <h3 class="link-style-1"><a href="property-detail-v1.html">Gorgeous Apartment
                                                Building</a> </h3>
                                ...
                                <div class="box box-dream hv-one style-dream">
                                    <div class="image-group relative ">
                                        ...
                                        <div class="swiper-container noo carousel-2 img-style">
                                            ...
                                            <div class="swiper-wrapper ">
                                                <div class="swiper-slide"><img
                                                        src="assets/images/house/featured-4.jpg" alt="images"></div>
                                                <div class="swiper-slide"><img
                                                        src="assets/images/house/featured-2.jpg" alt="images"></div>
                                                <div class="swiper-slide"><img
                                                        src="assets/images/house/featured-3.jpg" alt="images"></div>
                                                <div class="swiper-slide"><img
                                                        src="assets/images/house/featured-7.jpg" alt="images"></div>
                                                <div class="swiper-slide"><img
                                                        src="assets/images/house/featured-5.jpg" alt="images"></div>
                                            </div>
                                            <div class="pagi2">
                                                <div class="swiper-pagination2"> </div>
                                            </div>
                                ...
                                <div class="box box-dream hv-one style-dream">
                                    <div class="image-group relative ">
                                        ...
                                        <div class="swiper-container noo carousel-2 img-style">
                                            ...
                                            <div class="swiper-wrapper ">
                                                <div class="swiper-slide"><img
                                                        src="assets/images/house/featured-32.jpg" alt="images">
                                                </div>
                                                <div class="swiper-slide"><img
                                                        src="assets/images/house/featured-12.jpg" alt="images">
                                                </div>
                                                <div class="swiper-slide"><img
                                                        src="assets/images/house/featured-13.jpg" alt="images">
                                                </div>
                                                <div class="swiper-slide"><img
                                ...
                                <div class="box box-dream hv-one style-dream">
                                    <div class="image-group relative ">
                                        ...
                                        <div class="swiper-container noo carousel-2 img-style">
                                            ...
                                            <div class="swiper-wrapper ">
                                                <div class="swiper-slide"><img
                                                        src="assets/images/house/featured-1.jpg" alt="images"></div>
                                                <div class="swiper-slide"><img
                                                        src="assets/images/house/featured-22.jpg" alt="images">
                                                </div>
                                                <div class="swiper-slide"><img
                                ...
                                <div class="box box-dream hv-one style-dream">
                                    <div class="image-group relative ">
                                        ...
                                        <div class="swiper-container noo carousel-2 img-style">
                                            ...
                                            <div class="swiper-wrapper ">
                                                <div class="swiper-slide"><img
                                                        src="assets/images/house/featured-37.jpg" alt="images">
                                                </div>
                                                <div class="swiper-slide"><img
                                                        src="assets/images/house/featured-32.jpg" alt="images">
                                                </div>
                                                <div class="swiper-slide"><img
                                                        src="assets/images/house/featured-33.jpg" alt="images">
                                                </div>
                                                <div class="swiper-slide"><img
                                                        src="assets/images/house/featured-34.jpg" alt="images">
                                                </div>
                                                <div class="swiper-slide"><img
                                                        src="assets/images/house/featured-35.jpg" alt="images">
                                                </div>
                                            </div>
                                            <div class="pagi2">
                                                <div class="swiper-pagination2"> </div>
                                ...
                                <div class="box box-dream hv-one style-dream">
                                    <div class="image-group relative ">
                                        ...
                                        <div class="swiper-container noo carousel-2 img-style">
                                            ...
                                            <div class="swiper-wrapper ">
                                                <div class="swiper-slide"><img
                                                        src="assets/images/house/featured-6.jpg" alt="images"></div>
                                                <div class="swiper-slide"><img
                                                        src="assets/images/house/featured-22.jpg" alt="images">
                                                </div>
                                                <div class="swiper-slide"><img
                                    ...
                                    <div class="content">
                                        ...
                                        <div class="days-box flex justify-space align-center">
                                            <a class="compare flex align-center fw-6" href="#">Compare</a>
                                            <div class="img-author hv-tool" data-tooltip="Kathryn Murphy"><img
                                                    src="assets/images/author/author-8.jpg" alt="images"></div>
                                            <div class="days">3 years ago</div>
                                        </div>
                                    </div>
                                </div>
                                ...
                                <div class="box box-dream hv-one style-dream">
                                    <div class="image-group relative ">
                                        ...
                                        <div class="swiper-container noo carousel-2 img-style">
                                            ...
                                            <div class="swiper-wrapper ">
                                                <div class="swiper-slide"><img
                                                        src="assets/images/house/featured-30.jpg" alt="images">
                                                </div>
                                                <div class="swiper-slide"><img
                                                        src="assets/images/house/featured-12.jpg" alt="images">
                                                </div>
                                    ...
                                    <div class="content">
                                        ...
                                        <div class="days-box flex justify-space align-center">
                                            <a class="compare flex align-center fw-6" href="#">Compare</a>
                                            <div class="img-author hv-tool" data-tooltip="Kathryn Murphy"><img
                                                    src="assets/images/author/author-9.jpg" alt="images"></div>
                                            <div class="days">3 years ago</div>
                                        </div>
                                    </div>
                                </div>
                                ...
                                <div class="box box-dream hv-one style-dream">
                                    <div class="image-group relative ">
                                        ...
                                        <div class="swiper-container noo carousel-2 img-style">
                                            ...
                                            <div class="swiper-wrapper ">
                                                <div class="swiper-slide"><img
                                                        src="assets/images/house/featured-31.jpg" alt="images">
                                                </div>
                                                <div class="swiper-slide"><img
                                                ...
                                                <div class="swiper-slide"><img
                                                        src="assets/images/house/featured-9.jpg" alt="images">
                                                </div>
                                            </div>
                                            <div class="pagi2">
                                                <div class="swiper-pagination2"> </div>
                                    ...
                                    <div class="content">
                                        ...
                                        <div class="days-box flex justify-space align-center">
                                            <a class="compare flex align-center fw-6" href="#">Compare</a>
                                            <div class="img-author hv-tool" data-tooltip="Kathryn Murphy"><img
                                                    src="assets/images/author/author-12.jpg" alt="images"></div>
                                            <div class="days">3 years ago</div>
                                        </div>
                                    </div>
                                </div>
                                ...
                                <div class="box box-dream hv-one style-dream">
                                    <div class="image-group relative ">
                                        ...
                                        <div class="swiper-container noo carousel-2 img-style">
                                            ...
                                            <div class="swiper-wrapper ">
                                                ...
                                                <div class="swiper-slide"><img
                                                        src="assets/images/house/featured-3.jpg" alt="images">
                                                </div>
                                                <div class="swiper-slide"><img
                                    ...
                                    <div class="content">
                                        ...
                                        <div class="days-box flex justify-space align-center">
                                            <a class="compare flex align-center fw-6" href="#">Compare</a>
                                            <div class="img-author hv-tool" data-tooltip="Kathryn Murphy"><img
                                                    src="assets/images/author/author-10.jpg" alt="images"></div>
                                            <div class="days">3 years ago</div>
                                        </div>
                                    </div>
                                </div>
                                ...
                                <div class="box box-dream hv-one style-dream">
                                    ...
                                    <div class="content">
                                        ...
                                        <div class="days-box flex justify-space align-center">
                                            <a class="compare flex align-center fw-6" href="#">Compare</a>
                                            <div class="img-author hv-tool" data-tooltip="Kathryn Murphy"><img
                                                    src="assets/images/author/author-11.jpg" alt="images"></div>
                                            <div class="days">3 years ago</div>
                                        </div>
                                    </div>
                                </div>
                                ...
                                <div class="box box-dream hv-one style-dream">
                                    <div class="image-group relative ">
                                        ...
                                        <div class="swiper-container noo carousel-2 img-style">
                                            ...
                                            <div class="swiper-wrapper ">
                                                <div class="swiper-slide"><img
                                                        src="assets/images/house/featured-36.jpg" alt="images">
                                                </div>
                                                <div class="swiper-slide"><img
                                                        src="assets/images/house/featured-32.jpg" alt="images">
                                                </div>
                                    ...
                                    <div class="content">
                                        ...
                                        <div class="days-box flex justify-space align-center">
                                            <a class="compare flex align-center fw-6" href="#">Compare</a>
                                            <div class="img-author hv-tool" data-tooltip="Kathryn Murphy"><img
                                                    src="assets/images/author/author-17.jpg" alt="images"></div>
                                            <div class="days">3 years ago</div>
                                        </div>
                                    </div>
                                </div>
                                ...
                                <div class="box box-dream hv-one style-dream">
                                    <div class="image-group relative ">
                                        ...
                                        <div class="swiper-container noo carousel-2 img-style">
                                            ...
                                            <div class="swiper-wrapper ">
                                                <div class="swiper-slide"><img
                                                        src="assets/images/house/featured-29.jpg" alt="images">
                                                </div>
                                                <div class="swiper-slide"><img
                                                        src="assets/images/house/featured-22.jpg" alt="images">
                                                </div>
                                    ...
                                    <div class="content">
                                        ...
                                        <div class="days-box flex justify-space align-center">
                                            <a class="compare flex align-center fw-6" href="#">Compare</a>
                                            <div class="img-author hv-tool" data-tooltip="Kathryn Murphy"><img
                                                    src="assets/images/author/author-18.jpg" alt="images"></div>
                                            <div class="days">3 years ago</div>
                                        </div>
                                    </div>
                                </div>
                                ...
                                <div class="box box-dream hv-one style-dream">
                                    ...
                                    <div class="content">
                                        ...
                                        <div class="days-box flex justify-space align-center">
                                            <a class="compare flex align-center fw-6" href="#">Compare</a>
                                            <div class="img-author hv-tool" data-tooltip="Kathryn Murphy"><img
                                                    src="assets/images/author/author-19.jpg" alt="images"></div>
                                            <div class="days">3 years ago</div>
                                        </div>
                                    </div>
                                </div>
                                ...
                                <div class="widget widget-listings style">
                                    ...
                                    <div class="box-listings flex hover-img3">
                                        ...
                                        <div class="content link-style-1">
                                            <a class="fs-16 lh-24" href="property-detail-v1.html">Gorgeous Apartment
                                                Building</a>
                                            <h4>$7,500</h4>
                                        </div>
                                    </div>
                                    ...
                                    <ul class="group-estate flex">
                                        <li class="box-estate hover-img2">
                                            <div class="thumb img-style2 ">
                                                <img class="img2" src="assets/images/img-box/sidebar-estate-1.jpg"
                                                    alt="images">
                                            </div>
                                            <div class="content">
                                        ...
                                        <li class="box-estate hover-img2">
                                            <div class="thumb img-style2 ">
                                                <img class="img2" src="assets/images/img-box/sidebar-estate-2.jpg"
                                                    alt="images">
                                            </div>
                                            <div class="content">
                                                <div class="title link-style-3 fw-6 lh-18"><a
                                        ...
                                        <li class="box-estate hover-img2">
                                            <div class="thumb img-style2 ">
                                                <img class="img2" src="assets/images/img-box/sidebar-estate-3.jpg"
                                                    alt="images">
                                            </div>
                                            <div class="content">
                                                <div class="title link-style-3 fw-6 lh-18"><a
                                        ...
                                        <li class="box-estate hover-img2">
                                            <div class="thumb img-style2 ">
                                                <img class="img2" src="assets/images/img-box/sidebar-estate-4.jpg"
                                                    alt="images">
                                            </div>
                                            <div class="content">
                                                <div class="title link-style-3 fw-6 lh-18"><a
                                        ...
                                        <li class="box-estate hover-img2">
                                            <div class="thumb img-style2 ">
                                                <img class="img2" src="assets/images/img-box/sidebar-estate-5.jpg"
                                                    alt="images">
                                            </div>
                                            <div class="content">
                                                <div class="title link-style-3 fw-6 lh-18"><a
                                        ...
                                        <li class="box-estate hover-img2">
                                            <div class="thumb img-style2 ">
                                                <img class="img2" src="assets/images/img-box/sidebar-estate-6.jpg"
                                                    alt="images">
                                            </div>
                                            <div class="content">
                                                <div class="title link-style-3 fw-6 lh-18"><a
                                    ...
                                    <div class="box-ads">
                                        <div class="content relative z-2">
                                            ...
                                            <div class="text-addres ">
                                                <p class="p-12 text-color-1 icon-p">58 Hullbrook Road, Billesley, B13
                                                    0LA</p>
                                            </div>
                                            <div class="star flex">
