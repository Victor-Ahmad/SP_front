          ...
          <div class="row">
              <div class="col-lg-6">
                  <div class="heading-section">
                      <h2 class="font-2 fw-8 text-color-1">We provide the most suitable and quality real estate.
                      </h2>
                      <p class="text-color-1">Lorem ipsum dolor sit amet, consectetur adipiscing elit. Fusce sed
                              ...
                              <form method="post" id="contactform" class="comment-form form-submit"
                                  ...
                                  <div class="wd-find-select">
                                      ...
                                      <div class="nice-select relative" tabindex="0"><span
                                          ...
                                          <img class="img-icon icon-style" src="assets/images/icon/contact-choose.svg"
                                              alt="images">
                                      </div>
                                  </div>
