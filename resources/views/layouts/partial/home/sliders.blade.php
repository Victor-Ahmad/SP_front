                    ...
                    <div class="content po-content-two">
                        <div class="heading center">
                            <h1 class="text-color-1 wow slideInDown js-letters" data-wow-delay="50ms"
                                data-wow-duration="1000ms">Choose your home for future life</h1>
                                                ...
                                                <div class="inner-group">
                                                    <div class="form-group-1 search-form form-style">
                                                        <input type="search" class="search-field"
                                                            placeholder="Type keyword..." value="" name="s"
                                                    ...
                                                    <div class="form-group-2 form-style">
                                                        <div class="group-select">
                                                            <div class="nice-select" tabindex="0"><span
                                                                ...
                                                                <ul class="list">
                                                                    <li data-value class="option selected">Property
                                                                        type</li>
                                                                    ...
                                                                    <li data-value="smart-home" class="option">Smart
                                                                        Home</li>
                                                                    <li data-value="Single family home" class="option">
                                                                        Office</li>
                                                                    <li data-value="Multi family home" class="option">
                                                                        Villa</li>
                                                                </ul>
                                                            </div>
                                                        </div>
                                                    ...
                                                    <div class="form-group-3 form-style">
                                                        <div class="group-select">
                                                            <div class="nice-select" tabindex="0"><span
                                                                ...
                                                                <ul class="list">
                                                                    <li data-value class="option selected">Location
                                                                    </li>
                                                                    <li data-value="Japan" class="option">Japan</li>
                                                                    <li data-value="America" class="option d">
                                                                        America</li>
                                                                    <li data-value="England" class="option ">England
                                                                    </li>
                                                                    <li data-value="Japan" class="option">Belgium
                                                                    </li>
                                                                    <li data-value="England" class="option ">France
                                                                    </li>
                                                                    <li data-value="VietNam" class="option">VietNam
                                                                    </li>
                                                                </ul>
                                                            </div>
                                                        </div>
                                                    ...
                                                    <div class="form-group wg-box3">
                                                        <div class="group-select">
                                                            <div class="nice-select" tabindex="0"><span
                                                                ...
                                                                <ul class="list">
                                                                    <li data-value class="option selected">Baths:
                                                                        Any</li>
                                                    ...
                                                    <div class="form-group wg-box3">
                                                        <div class="group-select">
                                                            <div class="nice-select" tabindex="0"><span
                                                                ...
                                                                <ul class="list">
                                                                    <li data-value class="option selected">Beds:
                                                                        Any</li>
                                                                    <li data-value="1" class="option">1</li>
                                                                    <li data-value="2" class="option">2</li>
                                                                    <li data-value="3" class="option">3</li>
