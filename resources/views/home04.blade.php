                                                ...
                                                <ul class="navigation clearfix">
                                                    <li class="dropdown2 current"><a href="#">Home</a>
                                                        <ul>
                                                            ...
                                                            <li class="current"><a href="home04.html">Home Page 04</a>
                                                            </li>
                ...
                <div class="slider-item">
                    <div class="container  relative">
                        <div class="row">
                            <div class="col-lg-7">
                                <div class="heading">
                                    <h1 class="text-color-1 wow fadeInUp js-letters" data-wow-delay="0ms"
                                        data-wow-duration="1000ms">Choose your home for future life</h1>
                                    <p class="fs-16 lh-24 fw-6 text-color-1">Find a variety of properties that suit you
                                        very easily, forget all difficulties in finding a residence for you</p>
                                </div>
                            </div>
                            <div class="col-lg-5">
                                                    ...
                                                    <form method="post">
                                                        <div class="wd-find-select">
                                                                    ...
                                                                    <div class="nice-select" tabindex="0"><span
                                                                        ...
                                                                        <ul class="list">
                                                                            ...
                                                                            <li data-value="America" class="option d">
                                                                                America</li>
                                                                            <li data-value="England" class="option ">
                                                                                England</li>
                                                                            <li data-value="Japan" class="option">
                                                                                Belgium</li>
                                                                            <li data-value="England" class="option ">
                                                            ...
                                                            <div class="form-group flex">
                                                                <a
                                                                    class="sc-button icon-filter2 btn-1 btn-2 form-style center pull-right">
                                                                    <span>Filters</span>
                                                                ...
                                                                <div
                                                                    class="button-search sc-btn-top center no-absolute">
                            ...
                            <div class="swiper-container carousel-8">
                                <div class="swiper-wrapper ">
                                    <div class="swiper-slide ">
                                        <div class="box center hv-one">
                                            <div class="images img-style s-one relative">
                                                <img class="img2" src="assets/images/img-box/explore-1.jpg"
                                                    alt="images">
                                            </div>
                                    ...
                                    <div class="swiper-slide">
                                        <div class="box center hv-one">
                                            <div class="images img-style s-one relative">
                                                <img class="img2" src="assets/images/img-box/explore-2.jpg"
                                                    alt="images">
                                            </div>
                                            <div class="content link-style-1">
                                    ...
                                    <div class="swiper-slide">
                                        <div class="box center hv-one">
                                            <div class="images img-style s-one relative">
                                                <img class="img2" src="assets/images/img-box/explore-3.jpg"
                                                    alt="images">
                                            </div>
                                            <div class="content link-style-1">
                                                <a href="properties-map-v1.html">
                                    ...
                                    <div class="swiper-slide">
                                        <div class="box center hv-one">
                                            <div class="images img-style s-one relative">
                                                <img class="img2" src="assets/images/img-box/explore-4.jpg"
                                                    alt="images">
                                            </div>
                                            <div class="content link-style-1">
                                                <a href="properties-map-v1.html">
                                    ...
                                    <div class="swiper-slide">
                                        <div class="box center hv-one">
                                            <div class="images img-style s-one relative">
                                                <img class="img2" src="assets/images/img-box/explore-5.jpg"
                                                    alt="images">
                                            </div>
                                            <div class="content link-style-1">
                                                <a href="properties-map-v1.html">
                                    ...
                                    <div class="swiper-slide">
                                        <div class="box center hv-one">
                                            <div class="images img-style s-one relative">
                                                <img class="img2" src="assets/images/img-box/explore-6.jpg"
                                                    alt="images">
                                            </div>
                                            <div class="content link-style-1">
                                                <a href="properties-map-v1.html">
                                            ...
                                            <div class="content">
                                                ...
                                                <div class="days-box flex justify-space align-center">
                                                    ...
                                                    <div class="img-author hv-tool" data-tooltip="Kathryn Murphy"><img
                                                            src="assets/images/author/author-1.jpg" alt="images">
                                                    </div>
                                            ...
                                            <div class="content">
                                                ...
                                                <div class="days-box flex justify-space align-center">
                                                    <a class="compare flex align-center fw-6"
                                                        href="#">Compare</a>
                                                    <div class="img-author hv-tool" data-tooltip="Kathryn Murphy"><img
                                                            src="assets/images/author/author-3.jpg" alt="images">
                                                    </div>
                                                    <div class="days">3 years ago</div>
                                                </div>
                                            </div>
                                            ...
                                            <div class="content">
                                                ...
                                                <div class="days-box flex justify-space align-center">
                                                    <a class="compare flex align-center fw-6"
                                                        href="#">Compare</a>
                                                    <div class="img-author hv-tool" data-tooltip="Kathryn Murphy"><img
                                                            src="assets/images/author/author-4.jpg" alt="images">
                                                    </div>
                                                    <div class="days">3 years ago</div>
                                                </div>
                                            </div>
                                            ...
                                            <div class="content">
                                                ...
                                                <div class="days-box flex justify-space align-center">
                                                    <a class="compare flex align-center fw-6"
                                                        href="#">Compare</a>
                                                    <div class="img-author hv-tool" data-tooltip="Kathryn Murphy"><img
                                                            src="assets/images/author/author-5.jpg" alt="images">
                                                    </div>
                                                    <div class="days">3 years ago</div>
                                                </div>
                                            </div>
                                            ...
                                            <div class="content">
                                                ...
                                                <div class="days-box flex justify-space align-center">
                                                    <a class="compare flex align-center fw-6"
                                                        href="#">Compare</a>
                                                    <div class="img-author hv-tool" data-tooltip="Kathryn Murphy"><img
                                                            src="assets/images/author/author-6.jpg" alt="images">
                                                    </div>
                                                    <div class="days">3 years ago</div>
                                                </div>
                                            </div>
                                            ...
                                            <div class="content">
                                                ...
                                                <div class="days-box flex justify-space align-center">
                                                    <a class="compare flex align-center fw-6"
                                                        href="#">Compare</a>
                                                    <div class="img-author hv-tool" data-tooltip="Kathryn Murphy"><img
                                                            src="assets/images/author/author-7.jpg" alt="images">
                                                    </div>
                                                    <div class="days">3 years ago</div>
                                                </div>
                                            </div>
                        ...
                        <div class="col-lg-6">
                            <div class="wrap-search-today">
                                <div class="heading-section">
                                    ...
                                    <p class="font-2 text-color-2">Lorem ipsum dolor sit amet, consectetur adipiscing
                                    ...
                                    <div class="swiper-wrapper ">
                                        <div class="swiper-slide">
                                            <div class="box hover-img">
                                                <div class="images img-style">
                                                    <a href="agents-detail.html"><img
                                                            src="assets/images/img-box/search-today-1.jpg"
                                                            alt="images"></a>
                                                ...
                                                <div class="content">
                                                    <h3 class="link-style-1"><a href="agents-detail.html"> Darlene
                                                            Robertson</a></h3>
                                                    <p class="text-color-2 fs-12">Realtor</p>
                                                    <div class="meta">
                                                        <a href="agents-detail.html"
                                                            class="btn-button flex align-center fw-6 text-color-3"><span>Contact
                                                                seller</span>
                                        ...
                                        <div class="swiper-slide">
                                            <div class="box hover-img">
                                                <div class="images img-style">
                                                    <a href="agents-detail.html"><img
                                                            src="assets/images/img-box/search-today-2.jpg"
                                                            alt="images"></a>
                                                    <div class="icon-socials">
                                                        <a href="#"><i class="fab fa-facebook-f"></i></a>
                                                        <a href="#"><i class="fab fa-twitter"></i></a>
                            ...
                            <div class="wrap-icon">
                                <div class="box flex">
                                    ...
                                    <div class="content">
                                        ...
                                        <p class="text-color-2">The lists are always refreshed and updated constantly,
                                            you will never miss</p>
                                        <div class="meta style">
                                            <a href="#"
                                                class="btn-button flex align-center fs-13 fw-6 text-color-2"><span>See
                                                    all listings</span>
                                ...
                                <div class="box flex">
                                    ...
                                    <div class="content">
                                        <h4>Smart filter</h4>
                                        <p class="text-color-2">Find the right house for you in the shortest amount of
                                            time</p>
                                        <div class="meta style">
                                            <a href="#"
                                                class="btn-button flex align-center fs-13 fw-6 text-color-2"><span>See
                                ...
                                <div class="box flex">
                                    ...
                                    <div class="content">
                                        <h4>Great support</h4>
                                        <p class="text-color-2">After-sales care service, helpful advice to avoid
                                            scams</p>
                                        <div class="meta style">
                                            <a href="#"
                                                class="btn-button flex align-center fs-13 fw-6 text-color-2"><span>See
                ...
                <div class="container">
                    <div class="row">
                        ...
                        <div class="col-lg-4 col-md-4">
                            <div class="box hover-img">
                                <div class="images relative img-style">
                                    <a href="agents-detail.html"><img src="assets/images/img-box/meet-4.jpg"
                                            alt="images"></a>
                                    <div class="icon-socials">
                                        <a href="#"><i class="fab fa-facebook-f"></i></a>
                                        <a href="#"><i class="fab fa-twitter"></i></a>
                        ...
                        <div class="col-lg-4 col-md-4">
                            <div class="box hover-img">
                                <div class="images relative img-style">
                                    <a href="agents-detail.html"><img src="assets/images/img-box/meet-5.jpg"
                                            alt="images"></a>
                                    <div class="icon-socials">
                                        <a href="#"><i class="fab fa-facebook-f"></i></a>
                                        <a href="#"><i class="fab fa-twitter"></i></a>
                        ...
                        <div class="col-lg-4 col-md-4">
                            <div class="box hover-img">
                                <div class="images relative img-style">
                                    <a href="agents-detail.html"><img src="assets/images/img-box/meet-6.jpg"
                                            alt="images"></a>
                                    <div class="icon-socials">
                                        <a href="#"><i class="fab fa-facebook-f"></i></a>
                                        <a href="#"><i class="fab fa-twitter"></i></a>
